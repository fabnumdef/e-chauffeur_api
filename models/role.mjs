...
export const ROLE_USER = new RoleList(
  ...
  rights.CAN_LIST_SHUTTLE,
  rights.CAN_LIST_SHUTTLE_FACTORIES,
  rights.CAN_EDIT_SHUTTLE,
...
export const ROLE_REGULATOR = new RoleList(
  ...
  rights.CAN_CREATE_SHUTTLE_FACTORIES,
  rights.CAN_GET_SHUTTLE_FACTORIES,
  rights.CAN_UPDATE_SHUTTLE_FACTORIES,
  rights.CAN_DELETE_SHUTTLE_FACTORIES,
