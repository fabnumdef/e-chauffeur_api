...
export const CAN_CREATE_SHUTTLE_FACTORIES = campusRule('CAN_CREATE_SHUTTLE_FACTORIES');
export const CAN_LIST_SHUTTLE_FACTORIES = campusRule('CAN_LIST_SHUTTLE_FACTORIES');
export const CAN_GET_SHUTTLE_FACTORIES = campusRule('CAN_GET_SHUTTLE_FACTORIES');
export const CAN_UPDATE_SHUTTLE_FACTORIES = campusRule('CAN_UPDATE_SHUTTLE_FACTORIES');
export const CAN_DELETE_SHUTTLE_FACTORIES = campusRule('CAN_DELETE_SHUTTLE_FACTORIES');
export const CAN_DELETE_SHUTTLE = campusRule('CAN_DELETE_SHUTTLE');
export const CAN_LIST_SHUTTLE = campusRule('CAN_DELETE_SHUTTLE');
export const CAN_EDIT_SHUTTLE = campusRule('CAN_EDIT_SHUTTLE');
