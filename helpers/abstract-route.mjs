...
export function addCreateToRouter(Model, { url = '/', right } = {}) {
  if (!right) {
...
export function addListToRouter(Model, { url = '/', right, filters = {} } = {}) {
  if (!right) {
    throw new Error('Right should be defined');
  }
...
export function addGetToRouter(Model, { url = '/:id', right } = {}) {
  this.get(
    url,
    checkRights(right),
    maskOutput,
...
export function addDeleteToRouter(Model, { url = '/:id', right } = {}) {
  this.del(
    url,
    checkRights(right),
    async (ctx) => {
...
export function addUpdateToRouter(Model, { url = '/:id', right } = {}) {
  this.patch(
    url,
    checkRights(right),
    maskOutput,
